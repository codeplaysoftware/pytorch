...
class SYCLTemplateKernel(SYCLKernel):
    ...
    def call_kernel(
        ...
        # TODO (SYCL) : Extend support to cpp_wrapper once AOTInductor is supported
        ...
        if node.get_workspace_size() > 0:
            ...
            call_args.append(f"c_void_p({workspace}.data_ptr())")
        else:
            ws = None
            call_args.append("None")
...
class SYCLTemplateCaller(ChoiceCaller):
    ...
    Attributes:
        ...
        bmreq (SYCLBenchmarkRequest): The benchmark request for the caller (currently incomplete).
